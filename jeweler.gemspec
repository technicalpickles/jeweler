...
Gem::Specification.new do |s|
  ...
  s.files = ["README.markdown", "Rakefile", "TODO", "VERSION.yml", "bin/jeweler", "lib/jeweler.rb", "lib/jeweler", "lib/jeweler/bumping.rb", "lib/jeweler/errors.rb", "lib/jeweler/gemspec.rb", "lib/jeweler/release.rb", "lib/jeweler/templates", "lib/jeweler/templates/LICENSE", "lib/jeweler/templates/README", "lib/jeweler/templates/test", "lib/jeweler/templates/test/flunking_test.rb", "lib/jeweler/templates/test/test_helper.rb", "lib/jeweler/templates/spec", "lib/jeweler/templates/spec/spec_helper.rb", "lib/jeweler/templates/spec/flunking_spec.rb", "lib/jeweler/templates/Rakefile", "lib/jeweler/versioning.rb", "lib/jeweler/generator.rb", "lib/jeweler/tasks.rb", "test/fixtures", "test/fixtures/bar", "test/fixtures/bar/VERSION.yml", "test/jeweler_test.rb", "test/test_helper.rb", "test/jeweler_generator_test.rb", "lib/jeweler/templates/.gitignore"]

Feature: building gems
  ...
  Scenario: default
    ...
    When I run "rake build" in "existing-project-with-version"
    Then a file named 'existing-project-with-version/pkg/existing-project-with-version-1.5.3.gem' is created
